        ...
        var getTemplate = function (contentType) {
            ...
            switch (contentType) {
                case 'heading': template = '<header ck-editor-inline ck-style=\"header_styles\" contenteditable=\"true\" data-ng-model=\"component.data.text\"></header>';
                    break;
                case 'video': template = '<md-content data-ng-if=\"show(component)\" ><md-button class=\"md-accent md-raised esq-btn-float \" data-ng-click=\"clearComponent(component)\">Change Video</md-button><ent-video-preview video=\"component.data\"></ent-video-preview></md-content><md-content data-ng-if=\"!show(component)\"><video-search selected-video=\"component.data\"></video-search></md-content>';
                    break;
